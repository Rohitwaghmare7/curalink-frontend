...
export default function ChatPage() {
  ...
  const { messages, isLoading, sendMessage, clearChat } = useChat({ isGuest });

  // Load past conversation if URL has a sessionId
  useLoadConversation(isGuest ? null : urlSessionId);
